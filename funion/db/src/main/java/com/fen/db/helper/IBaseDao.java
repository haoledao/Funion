...
public interface IBaseDao<T> {
	 ...
	 * @return
	 */
	PagingTool<T> pagingQuery(String selection, String[] selectionArgs, int page, int pageSize);
	 ...
	 * @return
	 */
	PagingTool<T> pagingQuery(String[] columns, String selection, String[] selectionArgs, String orderBy, int page, int pageSize);
	 ...
	 * @return
	 */
	PagingTool<T> pagingQuery(String[] columns, String selection, String[] selectionArgs,
